<template>
  <div class="app-container">
    <el-form :model="queryTable" :inline="true" class="demo-form-inline">
      <el-row>
        <el-col :span="6">
          <el-form-item label="用户名" label-width="100">
            <el-input v-model="queryTable.userName" style="width: 240px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="用户ID">
            <el-input v-model="queryTable.userId" style="width: 240px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="企业名称">
            <el-input v-model="queryTable.companyName" style="width: 240px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="企业ID">
            <el-input v-model="queryTable.companyId" style="width: 240px"></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="6">
          <el-form-item label="追踪码">
            <el-input v-model="queryTable.traceId" style="width: 240px"></el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="6">
          <el-form-item label="请求地址">
            <el-input v-model="queryTable.url" style="width: 260px"></el-input>
          </el-form-item>
        </el-col>
    ...
    <el-table :data="articleTable" border height="600">
      ...
      <el-table-column label="请求方式" width="100" align="center">
        <template slot-scope="scope">
          <el-tag>{{scope.row.httpMethod}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="params" label="请求参数" min-width="300"></el-table-column>
      <el-table-column label="是否成功" width="80" align="center">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.success==='YES'" type="success">{{scope.row.success}}</el-tag>
          <el-tag v-else type="danger">{{scope.row.success}}</el-tag>
        </template>
      </el-table-column>
